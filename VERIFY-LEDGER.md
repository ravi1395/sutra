...
| Date | Version | Criterion | Surface | Evidence | Status |
|---|---|---|---|---|---|
| 2026-07-13 | 2.3.2 | DBG-10: debugpy subprocess child session attaches automatically; child breakpoint pauses with the child frame focused | B/UI | — | BLOCKED(run a Python fixture whose debugpy process spawns a subprocess, set a breakpoint in child code, start debugging → child session appears, breakpoint pauses child code, editor/call stack show the child frame) |
